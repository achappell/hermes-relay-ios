...
* chore(deps): bump actions/setup-python from 6.3.0 to 7.0.0 by @dependabot[bot] in https://github.com/achappell/hermes-relay-ios/pull/90
* chore(deps): bump apple-actions/upload-testflight-build from 5.3.0 to 5.4.0 by @dependabot[bot] in https://github.com/achappell/hermes-relay-ios/pull/89
### Other Changes
...
* fix(ios): align Standard Home bridge contract by @achappell in https://github.com/achappell/hermes-relay-ios/pull/78
* fix: declare the local STD-4 story alias by @achappell in https://github.com/achappell/hermes-relay-ios/pull/79
* feat(ios): activate live Home bridge pilot by @achappell in https://github.com/achappell/hermes-relay-ios/pull/80
* chore: configure BMAD issue tracking by @achappell in https://github.com/achappell/hermes-relay-ios/pull/81
* feat(ios): add Home configuration adapter by @achappell in https://github.com/achappell/hermes-relay-ios/pull/82
* fix(ios): accept the live Home bridge open and submit replies by @achappell in https://github.com/achappell/hermes-relay-ios/pull/83
* fix(ios): recover Home turns after reconnect by @achappell in https://github.com/achappell/hermes-relay-ios/pull/85
* Harden iOS BMAD issue tracking by @achappell in https://github.com/achappell/hermes-relay-ios/pull/84
* test(ios): close Home pairing review gate by @achappell in https://github.com/achappell/hermes-relay-ios/pull/86
* chore(status): refresh iOS sprint status by @achappell in https://github.com/achappell/hermes-relay-ios/pull/87
* docs: record iOS lane closeout and live Home verification by @achappell in https://github.com/achappell/hermes-relay-ios/pull/88
* docs(planning): apply approved nine-epic course correction by @achappell in https://github.com/achappell/hermes-relay-ios/pull/94
* IOS-HOME-02 slice 1: Pair iOS with Home and claim conversations by @achappell in https://github.com/achappell/hermes-relay-ios/pull/95
* fix(home): release finished Home turns on playback failure; profile Delete menu by @achappell in https://github.com/achappell/hermes-relay-ios/pull/96
* fix(home): publish pairing finished phase after activation announcement by @achappell in https://github.com/achappell/hermes-relay-ios/pull/97
* fix(ios): instrument Home prompt delivery boundary by @achappell in https://github.com/achappell/hermes-relay-ios/pull/98
